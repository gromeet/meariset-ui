 ...
 */
(function(){
  var MRS_VERSION = 124; /* 버전 번호 (12.4 = 124) — 쿠폰 배너 좌우 여백 제거 */
  ...
  .mrs-benefit-coupon{font-size:15px;font-weight:400;color:#2D2D2D;text-align:left;margin:12px 0 12px;padding:12px 14px;background:#F5F3EF;border-radius:0 10px 10px 0;border:none;border-left:3px solid #C8B48C;line-height:1.5;display:block;width:100%;max-width:none;box-sizing:border-box}\
