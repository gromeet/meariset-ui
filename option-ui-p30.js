 ...
 * product_no=30 전용 (step2 clone from option-ui.js)
...
(function(){
  ...
  /* product_no=30 에서만 실행 (step2 visual clone) */
  ...
  <div class="mrs-option-wrap" id="mrsOptionWrap">\
    <div class="mrs-cafe-banner">\
      <span class="mrs-cafe-text">☕ <span class="mrs-cafe-free">6주 인증 혜택 · 1권 제한</span></span>\
    </div>\
    <div class="mrs-grid">\
  ...
  var INFO_BY_COUNT={
    1:'<span class="mrs-info-tag best">6주 챌린지 인증 고객 전용</span><p class="mrs-info-price"><span id="mrsPriceNum">20,300</span>원 <span style="font-size:14px;font-weight:400;color:#e65100">+ 배송비 3,000원</span></p><p class="mrs-info-hint" style="cursor:default;animation:none">6주 인증 혜택 · 1권 제한</p>'
  };
