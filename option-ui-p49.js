 ...
 * product_no=49 전용 (30 안정판 기반 이식)
 * v8.0: 모바일 4열 단일행 + NaverPay MutationObserver 방어
 */
(function(){
  var MRS_VERSION = 175; /* 버전 번호 (17.5 = 175) — exact p30 stable base on served p49 path */
  ...
  /* product_no=49 에서만 실행 (30 안정판 기반 복제) */
  ...
  <div class="mrs-option-wrap" id="mrsOptionWrap">\
    <div class="mrs-cafe-banner">\
      <span class="mrs-cafe-text">☕ <span class="mrs-cafe-free">재구매 인증 혜택 · 1권 제한</span></span>\
    </div>\
    <div class="mrs-grid">\
  ...
  function insertUI(){
    ...
    if(existingWrap && existingWrap.querySelector('.mrs-card') && existingWrap.getAttribute('data-mrs-shell') !== 'p49-early') return; /* 이미 완성된 UI */
    ...
    var earlyShellStyle = document.getElementById('mrsP49EarlyShellStyles');
  ...
  var PRICE_BY_COUNT={1:24650};
  var INFO_BY_COUNT={
    1:'<span class="mrs-info-tag best">재구매 인증 고객 전용</span><p class="mrs-info-price"><span id="mrsPriceNum">24,650</span>원 <span style="font-size:14px;font-weight:400;color:#e65100">+ 배송비 3,000원</span></p><p class="mrs-info-hint" style="cursor:default;animation:none">재구매 인증 혜택 · 1권 제한</p>'
  };
  ...
  function mrsMakeAddonOptional(){
    ...
    if(row){
      ...
      if(nameNode){
        var txt=mrsGetText(nameNode);
        if(txt){
          nameNode.setAttribute('data-mrs-original-label', nameNode.getAttribute('data-mrs-original-label')||nameNode.innerHTML);
  ...
  function mrsSyncPenAddonSelection(enable, done, reason){
    ...
    _mrsPenSyncTimer=setTimeout(function(){
      if(prodOpt)prodOpt.setAttribute('style','display:none!important;position:fixed!important;left:-99999px!important;top:-99999px!important;width:1px!important;height:1px!important;overflow:hidden!important;opacity:0!important;');
      mrsSyncStickySoon();
  ...
  function mrsSelectOption(optionValue){
    ...
    mrsMakeAddonOptional();
    var prodOpt=document.querySelector('.productOption');
    if(prodOpt)prodOpt.setAttribute('style','display:block!important;position:fixed!important;left:0!important;top:0!important;width:1px!important;height:1px!important;overflow:hidden!important;opacity:0.01!important;z-index:-1!important;');
    sel.value=optionValue;
    mrsTriggerNativeChange(sel);
    setTimeout(function(){if(prodOpt)prodOpt.setAttribute('style','display:none!important;position:fixed!important;left:-99999px!important;top:-99999px!important;width:1px!important;height:1px!important;overflow:hidden!important;opacity:0!important;');},300);
    return true;
  }
  ...
  function mrsBuildAddonSubmitCache(){
    ...
    params.append('product_name','[재구매 15% 할인] 메아리셋 90일 목표달성 다이어리');
  ...
  function mrsBuildNoteBasketParams(optionValue){
    return {
      ...
      is_individual:'F',
      product_no:'49',
      product_name:'[재구매 15% 할인] 메아리셋 90일 목표달성 다이어리',
      main_cate_no:'1',
      display_group:'2',
      option_type:'T',
      product_min:'1',
  ...
  function mrsBuildCheckedProduct(list, optionValue, includePen){
    var targets=[{ product_no:'49', opt_id:String(optionValue||'').trim().replace(/^P00000BX/,'') }];
